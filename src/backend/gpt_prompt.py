def build_summary_prompt(performance: dict) -> str:
    ...
    return f"""
📌 작성 규칙
- 아래 공연 정보를 기반으로 감성적으로 요약하되, 반드시 bullet point 형식으로 작성해주세요.
...
|--------|-----------|
| {pid} |
- 공연 제목은 이렇게 매력적으로 전달됩니다
- 관람 연령과 장르에 맞춘 요약 문장이 들어갑니다
- 배우 정보나 기간 등은 요약에 자연스럽게 포함
- 문장마다 줄바꿈되어 bullet 형식 유지
"""